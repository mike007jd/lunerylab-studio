...
export const BYOK_PROVIDERS: ByokProviderMeta[] = [
  ...
  },
  {
    ...
    requiresEndpoint: false,
    requiresModelId: true,
    placeholderModelId: "grok-4.5",
    placeholderModelNote: "Current xAI model for creative, coding, and general text work.",
    sourceEvidence: {
      label: "xAI Grok 4.5 model docs",
      url: "https://docs.x.ai/developers/models/grok-4.5",
      lastVerifiedAt: "2026-07-31",
    },
    freshnessExpiresAt: "2026-08-30",
    imageApiMode: "none",
  },
  {
    id: "mistral",
    ...
    requiresEndpoint: false,
    requiresModelId: true,
    placeholderModelId: "mistral-large-latest",
    placeholderModelNote: "Current Mistral managed model; copy another exact ID from Mistral if you prefer a different model.",
    sourceEvidence: {
      label: "Mistral OpenAI-compatible migration guide",
  ...
  },
  {
    ...
    requiresEndpoint: false,
    requiresModelId: true,
    placeholderModelId: "deepseek-v4-flash",
    placeholderModelNote: "Current DeepSeek V4 fast model from the official Chat Completions API.",
    sourceEvidence: {
  ...
  },
  {
    ...
    requiresEndpoint: false,
    requiresModelId: true,
    placeholderModelId: "openai/gpt-oss-120b",
    placeholderModelNote: "Current Groq production model from the hosted model catalog.",
    sourceEvidence: {
  ...
  },
  {
    ...
    requiresEndpoint: false,
    requiresModelId: true,
    placeholderModelId: "sonar-pro",
    placeholderModelNote: "Perplexity's current web-grounded Sonar model through its OpenAI-compatible API.",
    sourceEvidence: {
      label: "Perplexity Sonar OpenAI compatibility",
  ...
  },
  {
    ...
    requiresEndpoint: false,
    requiresModelId: true,
    placeholderModelId: "gpt-oss-120b",
    placeholderModelNote: "Current Cerebras production model; preview models remain available through an explicit model ID.",
    sourceEvidence: {
      label: "Cerebras public model catalog",
